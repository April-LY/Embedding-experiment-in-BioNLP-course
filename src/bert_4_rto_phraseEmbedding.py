...
class config:
    def __init__(self):
        ...
        self.token_fre_file = '../data/tokenRTO.txt'
        ...
        self.log_file = '../model/rtophrases.biobert.log'
        ...
        self.embedding_save_path = '../model/rtoPhrases.bio-bert.embedding.txt'

        # TSNE parameters
        self.plot_only = 500
        self.tsne_save_file = '../model/rtoPhrases.tsne.bio-bert.png'
